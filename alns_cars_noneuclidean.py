...
#    la clase CarsGUI y sus graficos de matplotlib bloqueaban la
...
# ------------------------------------------------------------
# 5. API PROGRAMATICA -- para uso desde run_experiments.py
# ------------------------------------------------------------
def run(instance_path: str, seed: int = 42, verbose: bool = False) -> dict:
    ...
    (dist_matrix, edge_arr, edge_matrices, return_arr, n, nv, coords,
     nombre, formato, probs) = cargar_instancia_cars(instance_path)

    problema = CarRenterProblem(n, dist_matrix, edge_matrices, return_arr, formato=formato)
...
if __name__ == "__main__":
    ...
    # -------------------------------------------------
    (dist_matrix, edge_arr, edge_matrices, return_arr, n, nv, coords,
     nombre, formato, probs) = cargar_instancia_cars(filename)
    problema = CarRenterProblem(n, dist_matrix, edge_matrices, return_arr, formato=formato)
    problema.probabilidades = probs
